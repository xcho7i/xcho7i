...
# 💫 About Me:
Hello! I'm Jellow, an AI full-stack web & mobile developer building intelligent products that combine modern frontend experiences, scalable backend systems, and real-world AI capabilities.<br><br>

I design and ship LLM-powered apps, AI workflows, and cross-platform web/mobile products using React, Next.js, React Native, Flutter, Node.js, Python, and cloud infrastructure. My focus is on turning complex ideas into reliable, user-friendly systems that feel smart and perform at scale.<br><br>

I'm a lifelong learner driven by a desire to turn ideas into real products. Whether it's a web platform or a mobile app, I focus on delivering fast, accessible, and maintainable software that creates real value for users and businesses.
